  ...
  return (
    <>
      <div className='flex items-center justify-between gap-2'>
        <h1 className='text-2xl font-bold my-2 ml-3'>Product Management Tool</h1>
        <Button className='my-2 mr-3'>Add products</Button>
      </div>
      <div className='h-screen'>
        <div className='m-5 grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5'>
